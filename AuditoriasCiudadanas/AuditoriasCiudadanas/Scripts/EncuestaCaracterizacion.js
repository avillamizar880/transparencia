                ...
                if (result != null && result != "")
                {
                    for (var i = 0; i < result.Head.length; i++)
                    {
                        datasource = datasource +
                                 ...
                                 '<div class="col-sm-2"><a role="button" onclick="detalleReporteEncuesta_ajax(\'' + result.Head[i].FechaInicio + '\',\'' + result.Head[i].FechaFin + '\');"><span class="glyphicon glyphicon-download-alt">Ver detalle</span></a></div>' +
                                 '</div>';
                    }
                }
