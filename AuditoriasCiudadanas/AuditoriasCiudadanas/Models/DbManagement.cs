...
namespace AuditoriasCiudadanas.Models
{
  public class DbManagement
  {
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public static DataTable getDatosDataTable(string sSql, CommandType sTipoComando, string connString, List<PaParams> parametros)
    {
      DataTable functionReturnValue = default(DataTable);
      DataTable DatosSalida = new DataTable();
      DataTable tablaParametros = new DataTable("Params");
