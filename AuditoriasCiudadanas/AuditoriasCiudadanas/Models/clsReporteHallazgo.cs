...
namespace AuditoriasCiudadanas.Models
{
  public class clsReporteHallazgo
  {
    ...
    public static string GuardarReporteHallazgos(string detalle, int idGac, int idUsuario, string xml_info)
    {
      try
      {
        ...
        parametros.Add(new PaParams("@l_hallazgos", SqlDbType.Xml, xml_info, ParameterDirection.Input));
