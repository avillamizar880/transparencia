    	...
    	<form>
            ...
            <h4 class="text-center">•	Sobre la ejecución del proyecto:</h4>
                ...
                <h4 class="required">1.	¿Las actividades proyectadas por el ejecutor del proyecto fueron ejecutadas en el tiempo establecido? </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="PP1" nom_grupo="options">
              ...
              <div id="error_options" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
                ...
                <h4 class="required">2.	¿Los tiempos de ejecución del proyecto se han cumplido, si no ha sido así se ha informado a la comunidad de manera adecuada para no afectar su proceso de seguimiento?</h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="PP2" nom_grupo="options2">
                        <label class="btn btn-default">
             ...
             <div id="error_options2" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
                <div class="row">
                    <div class="col-sm-12 singleChoise">
            ...
            <div id="error_options4" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
             <div class="row">
               ...
               <div class="btn-group requerido" data-toggle="buttons" id="PP4" nom_grupo="options5">
                  <label class="btn btn-default">
            ...
            <div class="row">
                <div class="col-sm-12 singleChoise">
                    ...
                    <div class="btn-group requerido" data-toggle="buttons" id="PP5" nom_grupo="options6">
                        <label class="btn btn-default">
            ...
            <div id="error_options6" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
             <h4 class="text-center">•	Sobre las Audiencias de públicas:</h4>
               ...
               <div class="btn-group requerido" data-toggle="buttons" id="AP1" nom_grupo="options7">
                  <label class="btn btn-default">
           ...
           <div id="error_options7" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
               ...
               <div class="btn-group requerido" data-toggle="buttons" id="AP2" nom_grupo="options8">
                  <label class="btn btn-default">
            ...
            <div id="error_options8" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
               ...
               <div class="btn-group requerido" data-toggle="buttons" id="AP31" nom_grupo="options9">
                  <label class="btn btn-default">
               ...
               <div class="btn-group requerido" data-toggle="buttons" id="AP32" nom_grupo="options10">
                  <label class="btn btn-default">
                  ...
                  <label class="btn btn-default">
                    ...
                    <div class="btn-group requerido" data-toggle="buttons" id="AP33" nom_grupo="options11">
                        <label class="btn btn-default">
                            <input type="radio" name="options11" id="AP33_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options11" id="AP33_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
               ...
               <div class="btn-group requerido" data-toggle="buttons" id="AP34" nom_grupo="options12">
                  <label class="btn btn-default">
                  ...
                  <label class="btn btn-default">
                    ...
                    <div class="btn-group requerido" data-toggle="buttons" id="AP35" nom_grupo="options13">
                        <label class="btn btn-default">
                            <input type="radio" name="options13" id="AP35_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options13" id="AP35_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
                    ...
                    <div class="btn-group requerido" data-toggle="buttons" id="AP36" nom_grupo="options25">
                        <label class="btn btn-default">
                            <input type="radio" name="options25" id="AP36_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options25" id="AP36_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
                ...
                <h4 class="required">o	Grupo Auditor Ciudadano </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP41" nom_grupo="options14">
                        <label class="btn btn-default">
                            <input type="radio" name="options14" id="AP41_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options14" id="AP41_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
                 <div id="error_options14" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
                <h4 class="required">o	Interventor</h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP42" nom_grupo="options15">
                        <label class="btn btn-default">
                            <input type="radio" name="options15" id="AP42_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options15" id="AP42_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
                    <div id="error_options15" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
                    <h4 class="required">o	Supervisor </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP43" nom_grupo="options16">
                        <label class="btn btn-default">
                            <input type="radio" name="options16" id="AP43_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options16" id="AP43_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
                    <div id="error_options16" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
                    <h4 class="required">o	Contratista </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP44" nom_grupo="options17">
                        <label class="btn btn-default">
                            <input type="radio" name="options17" id="AP44_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options17" id="AP44_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
                    <div id="error_options17" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
                    <h4 class="required">o	Entidad Ejecutora </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP45" nom_grupo="options18">
                        <label class="btn btn-default">
                            <input type="radio" name="options18" id="AP45_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options18" id="AP45_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
                    <div id="error_options18" class="alert alert-danger alert-dismissible" hidden="hidden">No ha seleccionado ninguna respuesta</div>
                    <h4 class="required">o	Entidad territorial </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP46" nom_grupo="options19">
                        <label class="btn btn-default">
                            <input type="radio" name="options19" id="AP46_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options19" id="AP46_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
             ...
             <div class="row">
                ...
                <h4 class="required">5.	Hubo voluntad de la Entidad Territorial por atender las necesidades del Grupo Auditor ciudadano y lograr consolidar un buen trabajo entre la alcaldía y los ciudadanos.</h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP5" nom_grupo="options20">
                        <label class="btn btn-default">
                            <input type="radio" name="options20" id="AP5_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options20" id="AP5_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
             ...
             <div class="row">
                ...
                <h4 class="required">6.	La convocatoria de la Audiencias fue adecuada, por lo cual los líderes sociales, los beneficiarios del proyecto y las autoridades territoriales tuvieron un espacio de interacción adecuado. </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="AP6" nom_grupo="options21">
                        <label class="btn btn-default">
                            <input type="radio" name="options21" id="AP6_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options21" id="AP6_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
             ...
             <h4 class="text-center">•	Sobre el Grupo Auditor Ciudadano:</h4>
                ...
                <h4 class="required">1.	El Grupo Auditor Ciudadano cumplió adecuadamente con su plan de trabajo y promovió la participación de más ciudadanos en este proceso </h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="GP1" nom_grupo="options22">
                        <label class="btn btn-default">
                            <input type="radio" name="options22" id="GP1_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options22" id="GP1_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
            ...
            <div class="row">
                ...
                <h4 class="required">2.	El Grupo Auditor Ciudadano tuvo una comunicación fluida con los beneficiarios del proyecto.</h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="GP2" nom_grupo="options23">
                        <label class="btn btn-default">
                            <input type="radio" name="options23" id="GP2_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options23" id="GP2_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
            ...
            <div class="row">
                ...
                <h4 class="required">3.	La relación del Grupo Auditor Ciudadano con otros actores involucrados en la ejecución del proyecto benefició su seguimiento.</h4>
                    <div class="btn-group requerido" data-toggle="buttons" id="GP3" nom_grupo="options24">
                        <label class="btn btn-default">
                            <input type="radio" name="options24" id="GP3_op1" autocomplete="off" />
                            Si
                        </label>
                        <label class="btn btn-default">
                            <input type="radio" name="options24" id="GP3_op2" autocomplete="off" />
                            No
                        </label>
                    </div>
