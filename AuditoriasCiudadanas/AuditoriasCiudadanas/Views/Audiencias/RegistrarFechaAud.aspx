 ...
 <input type="hidden" id="hdIdUsuario" runat="server" />
    ...
    <div class="w60 center-block">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group required">
                    <%--proyecto--%>
                     <label for="txtProyecto">BPIN-Proyecto</label>
        ...
        <div class="row">
             <div class="col-sm-6">
                 <div class="form-group required">
                     <label for="ddlTipoAudiencia">Tipo Audiencia</label>
        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="form-group">
                    <label for="txtLugar">Lugar-Municipio</label>
        ...
        <div class="row">
             <div class="col-sm-6">
                <div class="form-group">
                    <label for="dtp_fecha" class="control-label">Fecha</label>
