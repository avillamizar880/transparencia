<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscadorProyectosAuditores111.aspx.cs" Inherits="AuditoriasCiudadanas.Views.AccesoInformacion.BuscadorProyectosAuditores" %>
<div class="input-group">
    <input id="txtPalabraClave" type="text" class="form-control" placeholder="Buscar Proyectos..." />
    <span class="input-group-btn">
        <button class="btn btn-info" type="button" onclick="CargarProyectosAuditores()"><span class="glyphicon glyphicon-search"></span></button>
    </span>
</div>
