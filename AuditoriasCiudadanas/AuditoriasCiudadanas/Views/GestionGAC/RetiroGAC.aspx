        ...
        <div class="center-block w60">
            ...
            <form id="form1" runat="server">
                <div class="form-group">
                    ...
                    <input id="txtmunicipio" class="form-control" required="required" type="text" placeholder="Municipio en el que reside" autocomplete="on"/> <p id="message" hidden="hidden"></p>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ocupacion" placeholder="Ocupación"/>
                    </div>
                    <div class="form-group">
